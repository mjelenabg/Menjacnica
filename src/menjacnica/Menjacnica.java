...
public class Menjacnica implements MenjacnicaInterfejs {
	...
	public Valuta nadjiKurs(String nazivValute, String skraceniNazivValute, GregorianCalendar datum) {
		...
		if((nazivValute==null && skraceniNazivValute==null) || datum==null)
			throw new RuntimeException("Morate uneti naziv valute ciji kurs trazite i datum za koji taj kurs trazite.");
